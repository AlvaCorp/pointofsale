                            ...
                            <tr>
                                <td>
                                    <address>
                                            ...
                                            <br /><br />
                                            <p><span>NOMOR : <strong>'.Penjualan::model()->find(array('condition'=>"$code"))->kd_penjualan.'</strong></span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>TANGGAL : <strong>'.Penjualan::model()->find(array('condition'=>"$code"))->date.'</strong></span></p>
                                    </address>
                                </td>
                                <td align="right">
                        ...
                        <table class="table">
                            <tr>
                                <td>
                                    <address>
                                            <p><b><i>Pembeli</i></b></p>
                                            <p>NAMA &nbsp;&nbsp;&nbsp;&nbsp;: <span>'.Customer::model()->findByPk(Penjualan::model()->find(array('condition'=>"$code"))->customer_id)->name.'</span></p>
                                            <p>ALAMAT : <span>'.Customer::model()->findByPk(Penjualan::model()->find(array('condition'=>"$code"))->customer_id)->alamat.'</span></p>
                                    </address>
                                </td>
                                <td align="left">
                                    <span>NOMOR POLISI : '.DetailKendaraan::model()->findByPk(LogKendaraan::model()->findByPk(Penjualan::model()->find(array('condition'=>"code='$penjualan->code'"))->log_kendaraan_id)->detail_kendaraan_id)->nopol.'</span>
                                </td>
                            </tr>
                        </table>
		</header>
