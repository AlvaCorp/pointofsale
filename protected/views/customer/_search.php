<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'customer_info_id',array('class'=>'span5')); ?>

	<?php echo $form->textFieldRow($model,'customer_category_id',array('class'=>'span5')); ?>
	...
	<?php echo $form->textFieldRow($model,'no_ktp',array('class'=>'span5','maxlength'=>32)); ?>
