...
class DetailPenjualan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
                        array('product_id, tanggal_produksi, jumlah', 'required'),
			array('product_category_id, product_type_id, merk_product_id, penjualan_id, product_id, jumlah', 'numerical', 'integerOnly'=>true),
			array('total_harga', 'numerical'),
			array('kode_produksi', 'length', 'max'=>512),
			array('tanggal_produksi', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, product_category_id, product_type_id, merk_product_id, penjualan_id, product_id, tanggal_produksi, kode_produksi, jumlah, total_harga', 'safe', 'on'=>'search'),
		);
	}
