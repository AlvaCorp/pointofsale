 ...
 * @property integer $id
 * @property integer $penjualan_type_id
...
class Penjualan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('penjualan_type_id, organisation_id, tipe_penjualan_id, parent_id, user_role_id, customer_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, penjualan_type_id, organisation_id, tipe_penjualan_id, parent_id, user_role_id, customer_id, kd_penjualan, code, date, total, bayar', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'penjualan_type_id' => 'Penjualan Type',
			'organisation_id' => 'Organisation',
			'tipe_penjualan_id' => 'Tipe Penjualan',
			'parent_id' => 'Parent',
			'user_role_id' => 'User Role',
			'customer_id' => 'Customer',
			'kd_penjualan' => 'Kode Penjualan',
			'code' => 'Code',
			'date' => 'Tanggal',
			'total' => 'Total',
			'bayar' => 'Bayar',
	...
	public function search()
	{
		...
		$criteria->compare('penjualan_type_id',$this->penjualan_type_id);
