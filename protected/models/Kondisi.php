 ...
 *
 * The followings are the available columns in table 'kondisi':
 * @property integer $id
...
class Kondisi extends CActiveRecord
{
	 ...
	 * @return Kondisi the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'logKendaraans' => array(self::HAS_MANY, 'LogKendaraan', 'kondisi_id'),
		);
	}
