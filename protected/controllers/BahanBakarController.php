...
class BahanBakarController extends Controller
{
	...
	public function actionIndex()
	{
		...
		$model=new BahanBakar('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['BahanBakar']))
			$model->attributes=$_GET['BahanBakar'];

		$this->render('admin',array(
			'model'=>$model,
		));
                /*
		$dataProvider=new CActiveDataProvider('BahanBakar');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bahan-bakar-form')
		{
