...
class CustomerController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('index', 'view', 'loadkota', 'admin', 'autocomplete', 'create','update', 'delete'),
				'users'=>array('@'),
                                //'roles'=>array('admin')
			),
                        /*
	...
	public function actionAutocomplete () {
	  if (isset($_GET['term'])) {
		...
		$criteria->condition = "Customer.name like '" . $_GET['term'] . "%'";
	 
		$dataProvider = new CActiveDataProvider(get_class(Customer::model()), array(
